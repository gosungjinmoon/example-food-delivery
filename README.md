...
![image](https://user-images.githubusercontent.com/55925545/205536070-3d86f2cf-ebcb-4eee-a065-db7876385142.png)
...
기능적 요구사항
1. 고객이 메뉴를 선택하여 주문한다.
1. (수정) 고객이 선택한 메뉴에 대해 결제 방법을 선택하고 결제한다.
1. (추가) PG사에서 결제 승인 여부 카톡 알림 메시지로 보낸다
